    ...
    [727], {
        3556: (e, t, n) => {
            ...
            t.default = class AnchorLinks {
                constructor(e, t) {
                    (0, o.default)(this, "observer", null), this.$anchorLinks = e, this.activeAnchorClass = t.activeAnchorItem, this.anchorClass = t.anchorItem
                }
                getViewportHeight() {
        ...
        3431: (e, t, n) => {
            ...
            class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
                ...
                getDefaultSettings() {
                    ...
                    return e.selectors.elementorWidgetWrapper = ".elementor-widget-n-menu", e.selectors.widgetContainer = ".e-n-menu", e.selectors.dropdownMenuToggle = ".e-n-menu-toggle", e.selectors.menuWrapper = ".e-n-menu-wrapper", e.selectors.headingContainer = ".e-n-menu-heading", e.selectors.menuItem = ".e-n-menu-item", e.selectors.tabTitle = ".e-n-menu-title", e.selectors.tabTitleText = ".e-n-menu-title-text", e.selectors.directTabTitle = ":scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-title", e.selectors.tabClickableTitle = ".e-n-menu-title.e-click", e.selectors.tabDropdown = ".e-n-menu-dropdown-icon", e.selectors.menuContent = ".e-n-menu-content", e.selectors.tabContent = ".e-n-menu-content > .e-con, .e-n-menu-heading > .e-con", e.selectors.directTabContent = ":scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-content > .e-con, :scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con", e.selectors.tabContentBeforeInterlacing = "> .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con", e.selectors.newContainerAfterRepeaterAction = "> .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con, > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-content > .e-con:nth-child( 2 )", e.selectors.anchorLink = ".e-anchor a", e.classes.anchorItem = "e-anchor", e.classes.activeAnchorItem = "e-current", e.autoExpand = !1, e.autoFocus = !1, e.ariaAttributes.titleStateAttribute = "aria-expanded", e.ariaAttributes.activeTitleSelector = '[aria-expanded="true"]', e.postUrl = "post-url", e.internalUrl = "internal-url", e
                }
                getDefaultElements() {
                    const e = super.getDefaultElements(),
                        t = this.getSettings("selectors");
                    return e.$widgetContainer = this.$element.find(t.widgetContainer), e.$dropdownMenuToggle = this.$element.find(t.dropdownMenuToggle), e.$menuWrapper = this.$element.find(t.menuWrapper), e.$menuContent = this.$element.find(t.menuContent), e.$headingContainer = this.$element.find(t.headingContainer), e.$menuItems = this.$element.find(t.menuItem), e.$tabTitles = this.$element.find(t.tabTitle), e.$tabDropdowns = this.$element.find(t.tabDropdown), e.$anchorLink = this.$element.find(t.anchorLink), e.$tabContentsBeforeInterlacing = this.$element.find(t.tabContentBeforeInterlacing), e
                }
                ...
                activateTab(e) {
                    ...
                    this.addAnimationToContentIfNeeded(e), l[t.showTabFn](r, (() => this.onShowTabContent(l))), s.attr(this.getTitleActivationAttributes()), s.prev(".e-n-menu-title-container").find("a").attr(this.getTitleActivationAttributes("link")), this.elements.$menuContent.addClass(n), l.addClass(n), l.css({
                        display: "var(--display)"
