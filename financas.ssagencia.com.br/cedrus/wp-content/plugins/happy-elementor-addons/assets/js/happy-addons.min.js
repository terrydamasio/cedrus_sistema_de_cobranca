function haObserveTarget(e, n) {
    ...
    function u(e) {
        ...
        e.$element.on("click", e.selector, function(e) {
            e.preventDefault()
        }), h.fn.magnificPopup && (e.isEnabled ? (t = h(window).width(), n = elementorFrontendConfig.breakpoints.md, a = elementorFrontendConfig.breakpoints.lg, e.$element.find(e.selector).magnificPopup({
            key: e.key,
            type: "image",
            image: {
                titleSrc: function(e) {
    ...
    function m(e) {
        ...
        n[{
            ...
            var e = setTimeout(function() {
                l.trigger("resize.twentytwenty"), clearTimeout(e)
            }, 400)
        })
    }
    h.fn.getHappySettings = function() {
        return this.data("happy-settings")
    }, l.on("elementor/frontend/init", function() {
        function e(e) {
        ...
        var t = elementorModules.frontend.handlers.Base,
            n = t.extend({
                ...
                getDefaultSettings: function() {
                    return {
                        ...
                        rows: 0,
                        slidesToShow: 1,
                        prevArrow: h("<div />").append(this.findElement(".slick-prev").clone().show()).html(),
                        nextArrow: h("<div />").append(this.findElement(".slick-next").clone().show()).html()
                    }
                },
                ...
                onElementChange: d(function() {
                    this.elements.$container.slick("unslick"), this.run()
                }, 200),
                getSlickSettings: function() {
                    var e = 1 == h('html[dir="rtl"]').length || h("body").hasClass("rtl"),
            ...
            a = t.extend({
                onInit: function() {
                    t.prototype.onInit.apply(this, arguments), this.run(), this.runFilter(), l.on("resize", d(this.run.bind(this), 100))
                },
            ...
            i = t.extend({
                ...
                runFilter: function() {
                    ...
                    c(t.$element, function(e) {
                        "*" !== e && (a.lastRow = "nojustify", n.selector = e), a.filter = e, t.elements.$container.justifiedGallery(a), u(n)
                    })
                },
                onElementChange: function(e) {
                ...
                run: function() {
                    this.elements.$container.justifiedGallery(this.getDefaultSettings()), u(this.getLightBoxSettings())
                }
            }),
            o = t.extend({
                onInit: function() {
            ...
            a = (elementorFrontend.hooks.addAction("frontend/element_ready/ha-slider.default", function(e) {
            ...
            }), h("body").on("click.onWrapperLink", "[data-ha-element-link]", function() {
                var e, t, n = h(this),
                ...
                "ha-twitter-feed.default": function(i) {
                    ...
                    e.on("click", function(e) {
                        ...
                        h.ajax({
                            ...
                            success: function(e) {
                                a < n ? h(e).appendTo(o) : (t.text("All Loaded").addClass("loaded"), setTimeout(function() {
                                    t.css({
                                        display: "none"
                                    })
                                }, 800))
                ...
                "ha-threesixty-rotation.default": function(a) {
                    ...
                    "on" === n ? ((e = a.find(".ha-threesixty-rotation-autoplay")).on("click", function(e) {
                        ...
                        a.find("img").each(function() {
                            -1 !== h(this).attr("style").indexOf("block") && (HappySimplaMagnify(h(this)[0], r), o.css("display", "none"), s.remove())
                        })
                ...
                "ha-data-table.default": function(e) {
                    ...
                    e.find(".ha-table__body-row").each(function(e, t) {
                        h(t).find(".ha-table__body-row-cell").each(function(e, t) {
                            h(t).prepend('<div class="ha-table__head-column-cell">' + n.eq(e).html() + "</div>")
                        })
                    })
                },
                section: e,
                ...
                "ha-image-accordion.default": function(e) {
                    ...
                    e.hasClass("ha-image-accordion-click") && (n = e.find(".ha-ia-item")).each(function(e, t) {
                        h(this).on("click", function(e) {
                            h(this).hasClass("active") || (n.removeClass("active"), h(this).addClass("active"))
                        })
                    })
                },
                "ha-content-switcher.default": function(e) {
                    ...
                    "button" == l.data("design-type") ? (n = l.find(".ha-cs-button"), a = l.find(".ha-cs-content-section"), n.each(function(e, t) {
                        h(this).on("click", function(e) {
                            e.preventDefault(), h(this).hasClass("active") || (n.removeClass("active"), h(this).addClass("active"), a.removeClass("active"), e = h(this).data("content-id"), l.find("#" + e).addClass("active"))
                        })
            ...
            r = (h.each(a, function(e, t) {
                ...
                jQuery(window).width() < 1025 && 767 < jQuery(window).width() && a.find(".ha-submenu-indicator-wrap").on("click", function(e) {
                    ...
                    var t = h(this).data("humberger"),
                        n = a.find("ul.menu");
                    "open" == t ? (h(".ha-menu-open-icon").addClass("hide-icon"), h(".ha-menu-close-icon").removeClass("hide-icon"), h(".ha-menu-close-icon").addClass("show-icon"), n.slideDown()) : (h(".ha-menu-close-icon").addClass("hide-icon"), h(".ha-menu-open-icon").removeClass("hide-icon"), h(".ha-menu-open-icon").addClass("show-icon"), n.slideUp())
                }), t(), l.on("resize", d(t, 100))
                ...
                run: function() {
                    var a, e, t, n, i, o, s = this,
                        r = JSON.parse(s.$element.find(".ha-lhi-image-area").attr("data-settings")),
                        l = s.$element.find(".ha-lhi-image"),
                        d = s.$element.find(".ha-lhi-title h2"),
                        h = s.$element.find(".ha-lhi-title p"),
                        c = s.$element.find("canvas"),
                        u = r.hover_style;
                    c && c.remove(), new hoverEffect({
                        parent: l[0],
                        intensity: r.intensity,
                        image1: r.first_image,
                        image2: r.second_image,
                        displacementImage: r.plugin_url + "liquid-hover-image/" + r.hover_effect,
                        imagesRatio: l.height() / l.width(),
                        angle1: (r.angle - 45) * (Math.PI / 180) * -1,
                        angle2: (r.angle - 45) * (Math.PI / 180) * -1,
                        speedIn: r.speed,
                        speedOut: r.speed
                    });
                    "style-1" == u && (d.length || h.length) && (a = r.style_1_direction, d.length && (d[0].innerHTML = d[0].textContent.replace(/\S/g, "<span class='letter'>$&</span>")), h.length && h.addClass("letter"), e = [0, 0], t = [0, 0], n = [0, 0], i = [0, 0], "left" == a ? (e = [80, 0], t = [0, -80]) : "right" == a ? (e = [0, 80], t = [80, 200]) : "up" == a ? (n = [80, 0], i = [0, -80]) : "down" == a && (n = [-80, 0], i = [0, 80]), s.$element.hover(function() {
                        anime.timeline({
                            loop: !1
                        }).add({
                            targets: ".elementor-element-" + s.getID() + " .ha-lhi-title .letter",
                            translateX: e,
                            translateY: n,
                            translateZ: 0,
                            opacity: [0, 1],
                        ...
                        anime.timeline({
                            ...
                            delay: function(e, t, n) {
                                return t = t, n = n, "right" == a ? 40 * (n - t) : 40 * t
                            }
                        })
                    })), "style-2" == u && (d.length || h.length) && (d.length && (o = d.find(".normal").outerHeight(), d.height(o)), h.length && (o = h.find(".normal").outerHeight(), h.height(o)), s.$element.hover(function() {
                        d.addClass("play"), h.addClass("play")
                    }, function() {
                        d.removeClass("play"), h.removeClass("play")
                    })), "style-5" == u && (d.length || h.length) && d.length && (o = d.find(".normal").outerHeight(), d.attr("style", "--ha-lhi-style-5-height:" + o + "px"))
                }
            }));
        elementorFrontend.hooks.addAction("frontend/element_ready/ha-liquid-hover-image.default", function(e) {
