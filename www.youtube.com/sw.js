...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "increase_min_pixel_width_to_show_channel_thumbnail_on_masthead_web": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20250213.05.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "pt",
            "gl": "BR",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20250213.05.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/e208051c\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/e208051c\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}