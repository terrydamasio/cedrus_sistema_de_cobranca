    ...
    */
    ...
    n.G = function(a, b) {
        ...
        if (c) {
            ...
            if (this.A)
                for (e = 0; e < c.length; e++) f = c[e], kb(this.g[f + 1], this.g[f + 2], d);
            else {
                this.m++;
                try {
    ...
    function vb() {
        for (var a = x(tb), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }
    ...
    function X(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a) {
            ...
            c || (W.yt_embedsEnableAutoplayAndVisibilitySignals ? (b = document.createElement("iframe"), Ab(this, b, a), this.i = a, ib(b, a), Bb(this, b, Cb(this, b)), a = b) : (b = document.createElement("iframe"), Ab(this, b, a), Bb(this, b, Cb(this)), this.i = a, ib(b, a), a = b));
            this.g = a;
            ...
            if (window.postMessage) {
                ...
                for (var e in ub) ub.hasOwnProperty(e) && Eb(this, e)
            }
        }
    }
    n = X.prototype;
    ...
    function Fb(a, b) {
        a.A[b] || (a.A[b] = !0, Gb(a, "addEventListener", [b]))
    }
    ...
    function Ib(a, b, c) {
        Z || (Z = {}, Mb = new Set, Ob.addEventListener("message", function(d) {
            a: if (Mb.has(d.origin)) {
                ...
                if (e && d.origin === e.N) switch (d = e.U, d.m = !0, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), e = f.event, f = f.info, e) {
                    ...
                    case "initialDelivery":
                        H(f) && (clearInterval(d.h), d.playerInfo = {}, d.v = {}, Lb(d, f.apiInterface), Kb(d, f));
                        break;
                    default:
                        d.j.i ||
                            (h = {
    ...
    I("YT.subscribe", function(a, b, c) {
        U.subscribe(a, b, c);
        ub[a] = !0;
        for (var d in V) V.hasOwnProperty(d) && Eb(V[d], a)
    });
